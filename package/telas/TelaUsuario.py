...
class TelaUsuario:
    def cadastrar_usuario(self):
        layout = [
            [sg.Text("qual o nome?")],
            [sg.Input(key="nome")],
            [sg.Text("data de nacimento")],
            [
                sg.Column([[sg.Input(key="nascimento")]], size=(125, 30)),
                sg.Column(
                    [
                        [
                            sg.CalendarButton(
        ...
        while True:
            if event == sg.WINDOW_CLOSED:
                ...
                if (
                    values["nome"] != ""
                    and values["nascimento"] != ""
                    and values["cpf"] != ""
                    and values["titulo"] != ""
                    and values["rg"] != ""
                    and values["email"] != ""
                    and values["senha"] != ""
                    and values["num_matricula"] != ""
                ):
                    nome = values["nome"]
    ...
    def listar_usuarios(self, lista):
        lista = lista
        layout = [sg.popup_scrolled(*lista, title="lista usuarios")]
