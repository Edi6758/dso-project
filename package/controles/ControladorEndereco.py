from package.telas.TelaEndereco import TelaEndereco
from package.entidades.Endereco import Endereco
from package.telas.TelaExcessoes import TelaExcessoes
from package.excessoes.EnderecoJahCadastradoException import EnderecoJahCadastrado
...
class ControladorEndereco:
    ...
    def cadastrar_endereco(self):
        ...
        try:
            endereco = Endereco(dados_endereco['estado'],
